...
public class TFrame2 extends Frame { 
    ...
    public TFrame2(){ 
        ...
        cbNilaiHuruf = new Checkbox("Nilai Huruf", cbg, false); this.add(cbNilaiHuruf).setBounds(100, 220, 90, 20); 
        cbNilaiAngka = new Checkbox("Nilai Angka", cbg, false); this.add(cbNilaiAngka).setBounds(200, 220, 90, 20); 
